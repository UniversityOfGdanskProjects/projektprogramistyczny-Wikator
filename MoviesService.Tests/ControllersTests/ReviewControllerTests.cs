...
public class ReviewControllerTests : ControllerTestsBase
{
    ...
    public async Task CreateReview_WhenUserAlreadyReviewedMovie_ReturnsBadRequest()
    {
        ...
        var controller = new ReviewController(QueryExecutorMock.Object, movieRepositoryMock.Object, reviewRepositoryMock.Object,
    ...
    public async Task UpdateReview_WhenReviewDoesNotExist_ReturnsNotFound()
    {
        // Arrange
        var reviewRepositoryMock = new Mock<IReviewRepository>();
        reviewRepositoryMock.Setup(x => x.ReviewExists(It.IsAny<IAsyncQueryRunner>(), It.IsAny<Guid>(), It.IsAny<Guid>()))
            .ReturnsAsync(false);
        
        var controller = new ReviewController(QueryExecutorMock.Object, It.IsAny<IMovieRepository>(), reviewRepositoryMock.Object,
            MqttServiceMock.Object, ClaimsProviderMock.Object);
    ...
    public async Task UpdateReview_WhenReviewExists_ReturnsOk()
    {
        ...
        reviewRepositoryMock.Setup(x => x.UpdateReview(It.IsAny<IAsyncQueryRunner>(), It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<UpdateReviewDto>()))
    ...
    public async Task DeleteReview_WhenReviewExists_ReturnsNoContent()
    {
        ...
        reviewRepositoryMock.Setup(x => x.GetMovieIdFromReviewId(It.IsAny<IAsyncQueryRunner>(), It.IsAny<Guid>(), It.IsAny<Guid>()))
