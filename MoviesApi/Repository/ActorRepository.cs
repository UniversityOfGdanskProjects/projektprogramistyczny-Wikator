...
{
    public async Task<ActorDto?> CreateActor(AddActorDto actor)
    {
    ...
    private static async Task<ActorDto?> CreateAndReturnActor(IAsyncQueryRunner tx, AddActorDto actorDto)
    {
        var actorQuery = $"" +
